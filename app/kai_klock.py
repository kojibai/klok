...
ETERNAL_WEEK_DESCRIPTIONS = {
    "Awakening Flame": "First week of the harmonic month — governed by the Root Spiral. Color: crimson red. Element: Earth + primal fire. Geometry: square base igniting upward. This is the week of emergence, where divine will enters density. Bones remember purpose. The soul anchors into action. Stability becomes sacred. Life says: I choose to exist. A spark catches in the base of your being — and your yes to existence becomes the foundation of the entire harmonic year.",
    ...
    "Harmonic Voice": "Fourth week — harmonized through the Throat Spiral. Color: sapphire blue. Element: Ether through sound. Geometry: standing wave inside a pentagon. This is the week of resonant truth. Sound becomes sacred code. Every word, a spell; every silence, a temple. You are called to speak what uplifts, to echo what aligns. Voice aligns with vibration — not for volume, but for verity. This is where the individual frequency merges with divine resonance, and the cosmos begins to listen.",

    "Inner Mirror": "Fifth week — governed by the Third Eye Spiral. Color: deep indigo. Element: sacred space and light-ether. Geometry: octahedron in still reflection. This is the week of visionary purification. The inner eye opens not to project, but to reflect. Truths long hidden surface. Patterns are made visible in light. This is the alchemy of insight — where illusion cracks and the mirror speaks. You do not look outward to see. You turn inward, and all worlds become clear.",
